...
# valid_table <- read_csv("Data/seirRefresh_validation_2param_tinit_beta0.01.csv") #equivalent
...
# experiment_name = "posnegWard Refresh valid2param tinit"
experiment_name = "posneg Refresh valid2param tinit extinction_threshold0"
...
# i = 1
  ...
  for(i in 1:NTESTS){
    ...
    res %>% write_csv(paste0("TempResults/BiasTest_seirRefresh_", experiment_name, "_Array", a, ".csv"))
