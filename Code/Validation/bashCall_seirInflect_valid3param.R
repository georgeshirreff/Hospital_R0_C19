...
# valid_table <- read_csv("Data/validation_table_3param_tinit_tinflect23.csv") #equivalent
valid_table <- read_csv("Data/BiasTest_3param.csv")
...
start_tinflect = valid_table_row$`start:t_inflect`
...
# i = 1
  ...
  for(i in 1:NTESTS){
    ...
    res %>% write_csv(paste0("TempResults/BiasTest_seirInflect_", experiment_name, "_Array", a, ".csv"))
